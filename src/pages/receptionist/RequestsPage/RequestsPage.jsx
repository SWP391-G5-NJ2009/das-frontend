...
function ReceptionistRequestsPage() {
  ...
  // const { requests, isLoading, error, refetch } = useConsultationRequests(filters);
  ...
  return (
    <Pagination currentPage={filters.pagination} totalPage={30} onPageChange={(page) => setFilters((prev) => ({ ...prev, pagination:page}))}/>
  );
  // return (
